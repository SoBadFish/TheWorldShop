package org.badfish.theworldshop.panel.lib;
...
public class DoubleChestFakeInventory extends ChestFakeInventory{
    ...
    public void onOpen(Player who) {
        ...
        Server.getInstance().getScheduler().scheduleDelayedTask(TheWorldShopMainClass.MAIN_INSTANCE,() -> onFakeOpen(who, blocks), 3);
    }
